...
ALLOWED_HOSTS = ['localhost','sccug-330-04.lancs.ac.uk','setapp.cloud']
...
PARTICLE_API_USERNAME = os.environ['PARTICLE_API_USERNAME']
PARTICLE_API_PASSWORD = os.environ['PARTICLE_API_PASSWORD']
