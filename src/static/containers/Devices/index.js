                        ...
                        <div>
                            ...
                            <div className="margin-top-medium">
                                ...
                                <p className="margin-bottom-small">
                                    ...
                                    &nbsp;<code>DevicesView</code> component, the action
                                ...
                                <p>
                                    Because the <code>DevicesView</code> is connected to the Redux store, when the
...
export { DevicesView as DevicesViewNotConnected };
